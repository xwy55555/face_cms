...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === "/index/system_config/dict_manage/dict_banks/list") {
          dispatch({
            type: 'initList',
  ...
  reducers: {
    ...
    deleteSuccess(state, action) {
      ...
      const newList = state.dataSource.filter(dictBanks => dictBanks.id !== id);
