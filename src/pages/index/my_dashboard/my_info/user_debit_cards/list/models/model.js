...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === "/index/my_dashboard/my_info/user_debit_cards/list") {
          dispatch({
            type: 'initList',
  ...
  reducers: {
    ...
    deleteSuccess(state, action) {
      ...
      const newList = state.dataSource.filter(userDebitCards => userDebitCards.id !== id);
