...
import { getPageList, edit, remove, removeBatch, changeOrderBy } from '../../services/service';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        if (location.pathname === '/index/customer_manage/groups/list') {
          dispatch({
            type: 'initList',
  ...
  reducers: {
    ...
    deleteSuccess(state, action) {
      ...
      const newList = state.dataSource.filter(groups => groups.id !== id);
